...
public class EmailsMessages {
    ...
    public static String ACTIVATE_MESSAGE(String email, String enterpriseName, String url){
        return "<div><h3>vacation-manager-app: aktywacja konta</h3>" +
                "<p>W celu dokonczenia rejestracji konta przejdz na podana strone " +
                "<a href='" + url + "/#/newAccount/" + email + "/" + enterpriseName+ "'> link activate " +
                "</a></p></div>";
    }

    public static String ACTIVATE_EMPLOYEE_MESSAGE(String email, String enterpriseName, String url, String passwd){
        return "<div><h3>vacation-manager-app: aktywacja konta pracownika</h3>" +
                "<p>W celu dokonczenia rejestracji konta przejdz na podana strone " +
                "<a href='" + url + "/#/newAccountEmployee/" + email + "/" + enterpriseName+ "'> link activate " +
