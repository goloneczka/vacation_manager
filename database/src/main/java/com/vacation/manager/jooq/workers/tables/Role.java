...
public class Role extends TableImpl<RoleRecord> {
    ...
    private static final long serialVersionUID = 257409546;

    /**
     * The reference instance of <code>workers.role</code>
     */
    ...
    /**
     * The column <code>workers.role.id</code>.
     */
    public final TableField<RoleRecord, Integer> ID = createField(DSL.name("id"), org.jooq.impl.SQLDataType.INTEGER.nullable(false).defaultValue(org.jooq.impl.DSL.field("nextval('workers.role_id_seq'::regclass)", org.jooq.impl.SQLDataType.INTEGER)), this, "");

    /**
     * The column <code>workers.role.name</code>.
     */
    ...
    /**
     * Create a <code>workers.role</code> table reference
     */
    public Role() {
    ...
    /**
     * Create an aliased <code>workers.role</code> table reference
     */
