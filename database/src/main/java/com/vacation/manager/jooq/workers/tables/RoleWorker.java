...
public class RoleWorker extends TableImpl<RoleWorkerRecord> {
    ...
    private static final long serialVersionUID = 1112628428;

    /**
     * The reference instance of <code>workers.role_worker</code>
     */
    ...
    /**
     * The column <code>workers.role_worker.worker_id</code>.
     */
    ...
    /**
     * The column <code>workers.role_worker.role_id</code>.
     */
    ...
    /**
     * Create a <code>workers.role_worker</code> table reference
     */
    public RoleWorker() {
    ...
    /**
     * Create an aliased <code>workers.role_worker</code> table reference
     */
    ...
    public List<ForeignKey<RoleWorkerRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<RoleWorkerRecord, ?>>asList(Keys.ROLE_WORKER__ROLE_WORKER_ROLE_ID_FKEY);
    }
