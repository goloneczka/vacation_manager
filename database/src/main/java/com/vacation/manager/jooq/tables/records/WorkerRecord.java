...
public class WorkerRecord extends UpdatableRecordImpl<WorkerRecord> implements Record7<Integer, String, Integer, String, String, String, Boolean> {

    private static final long serialVersionUID = -1954621762;
    ...
    @Override
    public Row7<Integer, String, Integer, String, String, String, Boolean> valuesRow() {
    ...
    @Override
    public WorkerRecord values(Integer value1, String value2, Integer value3, String value4, String value5, String value6, Boolean value7) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public WorkerRecord(Integer id, String email, Integer enterpriseId, String password, String name, String occupation, Boolean confirmed) {
        super(Worker.WORKER);
